...
def main(args):
    ...
    for trial in range(args.ntrials):
        ...
        discriminator0 = Edge_Discriminator(nnodes, nfeats, args.alpha, args.sparse).cuda()
        discriminator1 = Edge_Discriminator(nnodes, str_encodings.shape[1], args.alpha, args.sparse).cuda()
