...
def main(args):
    ...
    for trial in range(args.ntrials):
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            print("[TRAIN] Epoch:{:04d} | CL Loss {:.4f} ".format(epoch, cl_loss))
            ...
            if epoch % args.eval_freq == 0:
                ...
                print(
                    '[TEST] Epoch:{:04d} | CL loss:{:.4f} | VAL ACC:{:.2f} | TEST ACC:{:.2f} | DISC ACC:{:.2f}'.format(
                        epoch, cl_loss, acc_val, acc_test, acc_disc))
